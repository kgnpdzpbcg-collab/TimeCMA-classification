...
$embeddingRoot = 'Embeddings\CWRU_v7_prompt\mechanism-first-evidence-span-mean'
$outputDir = 'Results\CWRU_TimeCMA_FD\v7_prompt_lolo_load_v1\dual\seed_2024\test_3hp_val_0hp'
