...
结果布局把 seed 放进路径，避免多种子互相覆盖：
    ...
    Results\CWRU_TimeCMA_FD\v7_prompt_lolo_load_v1\<mode>\seed_<N>\<fold>\
...
param(
    ...
    [string]$EmbeddingRoot = 'Embeddings\CWRU_v7_prompt\mechanism-first-evidence-span-mean',
    [string]$ResultRoot = 'Results\CWRU_TimeCMA_FD\v7_prompt_lolo_load_v1',
